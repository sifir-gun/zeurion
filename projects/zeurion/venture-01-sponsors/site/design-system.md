...
- Indicateur de fraîcheur sous la fenêtre d'inbox : pastille --ok statique + « last observation [date] », date réelle du corpus, mise à jour à chaque rafraîchissement des données. Décision : le motif « updated live » avec pouls d'opacité (vu chez SponsorGap) est refusé, doublement non conforme : claim faux en phase 0 (pas de base live) et animation en boucle interdite.
