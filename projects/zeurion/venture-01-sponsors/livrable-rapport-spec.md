...
Version 1, 2026-07-21. Spec prête à exécuter en manuel (phase 0). Chaque étape de production est un geste à consigner dans phase-0-journal.md avec son niveau d'automatisation futur.
...
Format de livraison : PDF + tableur des contacts (CSV). Délai annoncé : 5 jours ouvrés.
